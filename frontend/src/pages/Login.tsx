...
import { Phone, Zap, Mail, Lock, ArrowRight, Eye, EyeOff } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-primary-600 to-cyan-600 p-12 relative overflow-hidden">
        ...
        >
          <div className="w-32 h-32 bg-white/20 backdrop-blur-xl rounded-3xl flex items-center justify-center mx-auto mb-8">
            <Phone className="w-16 h-16 text-white" />
          </div>
          <h2 className="text-3xl font-bold text-white mb-4">Your AI Assistant Awaits</h2>
          <p className="text-white/80 max-w-sm mx-auto">
            Access your dashboard to manage calls, train your AI, and view real-time analytics.
          </p>
        </motion.div>
      </div>
    </div>
